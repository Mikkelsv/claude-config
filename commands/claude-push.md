...
1. Review what changed using `git -C ~/.claude diff` and `git -C ~/.claude status --porcelain` to write a good commit message. Keep it concise (one line, imperative mood).
